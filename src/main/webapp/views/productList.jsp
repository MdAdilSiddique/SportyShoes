	...
	<table class ="table table-striped" border="1" width="100%" >  
		...
		<c:forEach  var="product" items="${products}">
			...
			<tr>
				...
				<td><a class="btn btn-primary" style="padding-left:25px; padding-right:25px; margin-top:30px" href="${editLink}">Edit</a></td>  
				<td><a class="btn btn-danger" style="margin-top:30px" href="${deleteLink}" onclick="if (!('are you sure you want to delete this todo?'))) return false">Delete</a></td>
			</tr>  
