	...
	<table class ="table table-striped" border="1" width="100%" >  
		...
		<c:forEach  var="prodCategory" items="${categories}">
			...
			<tr>
				...
				<td><a class="btn btn-primary" style="padding-left:25px; padding-right:25px; color:white"; href="${editLink}">Edit</a></td>  
				<td><a class="btn btn-danger"  href="${deleteLink}" onclick="if (!('are you sure you want to delete this todo?'))) return false">Delete</a></td>
			</tr>  
