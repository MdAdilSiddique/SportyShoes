...
<!-- <nav class="navbar navbar-dark bg-dark navbar-expand-sm"> -->
	 <img src="/images/shoeslogo.jpg" width="50" height="50" class="d-inline-block align-top" alt="Sporty Shoes">
    <h3>Sporty Shoes</h3>
 <ul class="nav nav-pills" role="tablist">
   ...
   <li class="nav-item">          
            <a class="nav-link" href="/cart"> 
          	<img src="/images/shopping-cart.gif" width="30" height="30" class="d-inline-block align-top" alt="">
          	Cart
